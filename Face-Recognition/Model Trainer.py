...
path = './Face-Recognition/samples' # Path for samples already taken
...
recognizer.write('./Face-Recognition/trainer/trainer.yml')  # Save the trained model as trainer.yml
